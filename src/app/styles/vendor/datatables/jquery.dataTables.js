...
(function( $, window, document, undefined ) {
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *  @type string
			 *  @default No existe información para mostrar
			 *
			 *  @dtopt Language
			 ...
			 *
			 *  @type string
			 *  @default Mostrando _START_ al _END_ de _TOTAL_ registros
			 *
			 *  @dtopt Language
			 ...
			 *  @type string
			 *  @default Mostrando 0 al 0 de 0 registros
			 *
			 *  @dtopt Language
			 ...
			 *    } );
			 */
			"sLengthMenu": "Muestra &nbsp _MENU_ &nbsp registros",
